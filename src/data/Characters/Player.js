...
class Player extends Person {
    constructor(coords, name, race, location, faction, stats, health, 
        ...
        factionLevels, questsCompleted, icon, spawn) {
        super(coords, name, race, location, faction, factionLevels, stats, health, 
        ...
        this.target = target;
        this.factionLevels = factionLevels;
...
var player = new Player([2, 4], "player", races.dwarf, locations.list.imperialPrisonShipDownstairs, 
[factions.ironforge], [1, 1, 1, 1, 1], [10, 10], 
[10, 10], [10, 10], 1, [["hearthstone", 1], ["butt", 2]], 
[items.weapons.copperBattleAxe, items.weapons.heavyCopperMaul, items.armor.platemailHelm, 
    items.armor.patchedLeatherShoulderpads, items.armor.raggedWolfHideCloak, 
    items.armor.roughCopperVest, items.armor.runedCopperBracers, items.armor.runedCopperGauntlets, 
    items.armor.runedCopperBelt, items.armor.runedCopperPants, items.armor.roughBronzeBoots], 
    [0, 100], 0, races.dwarf.baseStats, 0, [1,1], [], "@", []);
